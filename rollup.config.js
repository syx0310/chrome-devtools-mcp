        ...
        allow: {
          test: dependency => {
            return (
              ...
              // Apify's browser data dependency; attribution is emitted below.
              (dependency.name === 'caniuse-lite' &&
                dependency.license === 'CC-BY-4.0')
            );
          },
          ...
          template(dependencies) {
            ...
            const stringifiedDependencies = Array.from(
              ...
              if (dependency.name === 'caniuse-lite') {
                arr.push(
                  'Attribution: caniuse-lite by Ben Briggs and contributors.',
                  'Source: https://github.com/browserslist/caniuse-lite',
                  'Browser support data: https://caniuse.com/',
                  'License URL: https://creativecommons.org/licenses/by/4.0/',
                  'Changes: modules are bundled; browser support data values are unmodified.',
                );
              }
...
export default [
  bundleDependency('fingerprint-generator.js', {
    inlineDynamicImports: true,
    banner:
      "import {fileURLToPath as fingerprintFileURLToPath} from 'node:url';\nconst __dirname = fingerprintFileURLToPath(new URL('./fingerprint-data/', import.meta.url));",
  }),
  bundleDependency(
    'index.js',
    {
